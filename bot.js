...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "sa") {
    msg.reply(
      "<a:royal_elmas1:800645138836881419> **Aleyküm Selam, Hoşgeldin** <a:royal_elmas2:800645133804371968>"
    );
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "Merhaba") {
    msg.reply(
      "<a:royal_elmas1:800645138836881419> **Merhaba, Hoşgeldin** <a:royal_elmas2:800645133804371968>"
    );
  }
});
///////
...
let rol = member.guild.roles.cache.find(r => r.name === "Jail Cezayi Takip");
...
db.delete(`cezali_${member.guild.id + member.id}`)
    ...
    member.roles.remove('800447514909605928');
  }, ms(sürejail));
}
})
...
client.on('guildMemberAdd', async(member) => {
let mute = member.guild.roles.cache.find(r => r.name === "Royal Mute");
...
db.delete(`muteli_${member.guild.id + member.id}`)
    ...
    member.roles.remove('800447506492162078');
  }, ms(süre));
}
})
